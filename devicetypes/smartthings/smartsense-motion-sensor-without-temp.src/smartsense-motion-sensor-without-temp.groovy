 ...
 *  under the License.
 *
 * Lines commented out: 25, 53-56, 66-78, 86, 87, 101-103, 128-133, 163-166, 167, 178-185, 228-235, 286-305, 321, 342-344
 *
 */

metadata {
	definition (name: "SmartSense Motion Sensor Without Temp", namespace: "smartthings", author: "SmartThings modified by virus86", category: "C2") {
